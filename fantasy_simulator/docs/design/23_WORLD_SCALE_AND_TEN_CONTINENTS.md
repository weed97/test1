# 23 — 월드 스케일 (10만×10만) · 종족 5영역 · 왕국·마을

> **2026-06 갱신:** 대륙 10개 분할 대신 **에르도리아 단일 월드** 안에 **종족별 영역(realm)** 5개. 각 영역에 여러 **왕국·마을**이 특색을 갖는다.

## 한 줄 요약

**하나의 월드** (`100_000 × 100_000` 월드 좌표). 그 안에 **인간·드워프·엘프·다크엘프·수인** 영역이 있고, 영역마다 마을·왕국·세력 허브가 다르다.  
