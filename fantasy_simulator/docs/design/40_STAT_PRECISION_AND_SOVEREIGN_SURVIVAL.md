...
| **HP** | `hp_milli` | 준신 **1000000.000** · 필멸 극치 **99999.000** ([42](42_DEMIGOD_HP_AND_ARMOR_PIERCE.md)) |
...
## 아서 HP 100만 · 회복 초당 1000 — “절대 안 죽는” 문제

### 문제

- HP **100만** (준신) — 9999는 반신에게 **시시한 죽음**.
- 필멸 Lv999 극치 **99,999** (준신의 1/100) — 신화+VIT 없이 불가.
- 회복 `1000/s` (비전투) · 필멸 맥스뎀→아서 **1칩** → 솔로 딜로는 끝 없음.
