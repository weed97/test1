...
| 시나리오 | 결과 |
|----------|------|
| 100만 명이 동시에 HP 1씩 | **즉사** (풀=100만) |
| 방무 정예 120 × 9,999 | **즉사** (검주·연합 루트) |
| 30만 연합 · 합산 200 DPS − 회복 160 | **약 25,000초** (~7시간) |
