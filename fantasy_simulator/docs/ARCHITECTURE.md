...
**World product framing:** Eldoria is designed as a **VR×BCI×Mnemosyne** ultra-immersion isekai (five senses + somatic/proprioceptive “sixth sense”, reality-parity tier R3). See [design/README.md](design/README.md), [design/09_BCI_DEEPMIND_FUSION.md](design/09_BCI_DEEPMIND_FUSION.md). Optional state: `flags.vr_meta`, `flags.bci_meta` — schemas in `config/vr_meta.schema.json`, `config/bci_meta.schema.json`.
